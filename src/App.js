...
// Phone Icon specifically styled - Purple gradient for professional calling app aesthetic
const PhoneIcon = styled(SocialIcon)`
  background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);
  box-shadow: 0 4px 15px rgba(102, 126, 234, 0.4), 0 2px 4px rgba(0, 0, 0, 0.2);
  ...
  &:hover {
    ...
    box-shadow: 0 6px 25px rgba(102, 126, 234, 0.6), 0 4px 10px rgba(0, 0, 0, 0.3);
  }
...
// WhatsApp Icon - Official green gradient with authentic logo
const WhatsAppIcon = styled(SocialIcon)`
  background: linear-gradient(135deg, #25D366 0%, #128C7E 100%);
  box-shadow: 0 4px 15px rgba(37, 211, 102, 0.4), 0 2px 4px rgba(0, 0, 0, 0.2);
  ...
  &:hover {
    transform: translateY(-3px) scale(1.1);
    box-shadow: 0 6px 25px rgba(37, 211, 102, 0.6), 0 4px 10px rgba(0, 0, 0, 0.3);
  }
...
// Facebook Icon - Official blue gradient with white 'f' logo
const FacebookIcon = styled(SocialIcon)`
  background: linear-gradient(135deg, #1877F2 0%, #0C63D4 100%);
  box-shadow: 0 4px 15px rgba(24, 119, 242, 0.4), 0 2px 4px rgba(0, 0, 0, 0.2);
  ...
  &:hover {
    transform: translateY(-3px) scale(1.1);
    box-shadow: 0 6px 25px rgba(24, 119, 242, 0.6), 0 4px 10px rgba(0, 0, 0, 0.3);
  }
...
// Instagram Icon - Signature gradient with camera icon
const InstagramIcon = styled(SocialIcon)`
  background: linear-gradient(45deg, #833AB4 0%, #FD1D1D 50%, #FCB045 100%);
  box-shadow: 0 4px 15px rgba(131, 58, 180, 0.4), 0 2px 4px rgba(0, 0, 0, 0.2);
  ...
  &:hover {
    transform: translateY(-3px) scale(1.1);
    box-shadow: 0 6px 25px rgba(131, 58, 180, 0.6), 0 4px 10px rgba(0, 0, 0, 0.3);
  }
