        ...
        <FooterContainer>
          ...
          <FooterColumn>
            ...
            <SocialLinks style={{ marginTop: '2rem' }}>
              ...
              <a href="https://wa.me/9107710380077" target="_blank" rel="noopener noreferrer" title="WhatsApp">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
          ...
          <FooterColumn>
            ...
            <ContactInfo>
              ...
              <div className="contact-details">
                <h4>Location</h4>
                <p>Regal Residencia, Sector 114, Sahibzada Ajit Singh Nagar, Punjab 140307</p>
              </div>
            </ContactInfo>
          ...
          <FooterColumn>
            ...
            <DirectionsButton onClick={() => window.open('https://www.google.com/maps/dir/?api=1&destination=Regal+Residencia,+Sector+114,+Sahibzada+Ajit+Singh+Nagar,+Punjab+140307', '_blank')}>
               Get Directions
            </DirectionsButton>
          </FooterColumn>
        </FooterContainer>
